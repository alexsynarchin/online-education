    ...
    <section>
        ...
        <el-form ref="form" :model="form" label-position="top">
            <div class="row">
                ...
                <el-form-item class="col-lg-6" prop="faq_link" label="Ссылка на страницу поддержки">
                    <el-input v-model="form.faq_link"></el-input>
                </el-form-item>
                <el-form-item class="col-lg-6" prop="justice_link" label="Ссылка юридическая информация">
                    <el-input v-model="form.justice_link"></el-input>
                </el-form-item>
