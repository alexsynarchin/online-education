<template>
  <section>
      ...
      <el-button  type="primary" @click.prevent="storeCourse()"  style="text-transform: uppercase">Сохранить курс</el-button>
          <el-button  type="default" @click.prevent="closeCourse()"  style="text-transform: uppercase">Вернуться</el-button>
    </el-form>
  </section>
</template>
<script>
import { Errors } from  '@/common/js/services/errors.js';
  export default {
    ...
    methods: {
        closeCourse(){
            window.location.href='/admin/courses/' + this.form.id;
        },
      storeCourse() {
        ...
        .then((response) => {
            ...
            let url = '/admin/courses/' + this.form.id
